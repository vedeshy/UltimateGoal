...
@Autonomous(name="Ultimate Goal Auto", group="Linear Opmode")
//@Disabled
        ...
        if (tfod != null) {
            ...
            while (opModeIsActive()) {
                ...
                if (code == "none") {
                    ...
                    OdometryHelper.goToPosition(globalPositionUpdate, hardware, this, 0 * OdometryHelper.COUNTS_PER_INCH, -108 * OdometryHelper.COUNTS_PER_INCH, 0.5, 0.5 * OdometryHelper.COUNTS_PER_INCH, 0.0);
                    IMUHelper.gyroTurn(this, hardware, 0.0);
                    telemetry.addData("X Position", globalPositionUpdate.returnXCoordinate() / OdometryHelper.COUNTS_PER_INCH);
                    telemetry.addData("Y Position", globalPositionUpdate.returnYCoordinate() / OdometryHelper.COUNTS_PER_INCH);
                    telemetry.update();
